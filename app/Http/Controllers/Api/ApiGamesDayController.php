...
use App\Http\Resources\GamesDayCollection;
use App\Http\Resources\GamesDayResource;
use App\Services\GamesDayService;
use Illuminate\Http\JsonResponse;
use Validator;

class ApiGamesDayController extends ApiBaseController
{
    ...
    public function index(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendPaginate(new GamesDayCollection($data));
    ...
    public function all(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(GamesDayResource::collection($data));
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(new GamesDayResource($item));
    ...
    public function store()
    {
        try {
            ...
            if (!\Auth::user()->can('create', GamesDay::class)) {

                return $this->sendUnauthorized();
            }

            $storeRequest = new GamesDayStoreRequest();
    ...
    public function update()
    {
        try {
            ...
            if (!\Auth::user()->can('update', GamesDay::class)) {

                return $this->sendUnauthorized();
            }

            $updateRequest = new GamesDayUpdateRequest();
