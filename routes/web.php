...
Route::get('/iframe', 'Web\DashboardController@iframe')->name("iframe");
...
//Route::match(['get', 'post'], '/logoutManual', 'Auth\LoginController@logout')->name('logoutManual');
//
//#Route::get('/home', 'HomeController@index')->name('home_web');
//
//Route::namespace('Web')
...
//        $web->get('/iframe', 'DashboardController@iframe')->name("iframe");
//
